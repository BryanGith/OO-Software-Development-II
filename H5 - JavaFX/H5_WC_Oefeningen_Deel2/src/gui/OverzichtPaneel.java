...
public class OverzichtPaneel extends VBox {
	...
	private void buildGui() {
		...
		try {
			...
			// een eventhandler koppelen aan lvLijst
			/*
			 * lvList.getSelectionModel().selectedIndexProperty().addListener(new
			 * ChangeListener<Number>() {
			 * 
			 * @Override public void changed(ObservableValue<? extends Number> index, Number
			 * oud, Number nieuw) {
			 * 
			 * int geselecteerdeIndex = nieuw.intValue();
			 * dp.setIndexVanDeRekening(geselecteerdeIndex); dp.update(); }
			 * 
			 * });
			 */
