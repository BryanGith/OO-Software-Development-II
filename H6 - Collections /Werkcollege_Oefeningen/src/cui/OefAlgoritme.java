...
public class OefAlgoritme {
	public OefAlgoritme() {
		...
		System.out.printf("Het grootste element van de array getallen is: %d%n", getallen[getallen.length - 1]);

		// Toon het kleinste element van de array getallen
		// -----------------------------------------------
		System.out.printf("Het kleinste element van de array getallen is: %d%n", getallen[0]);
