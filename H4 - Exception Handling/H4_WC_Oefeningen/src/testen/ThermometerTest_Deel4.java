...
public class ThermometerTest_Deel4 {
	private Thermometer_Deel4 t;
    ...
    {
    	Assertions.assertThrows(IllegalArgumentException.class , () -> {new Thermometer_Deel4(105);});
    }

	@Test
	public void maakThermometer_aantalGraden104_maaktObject() {
		t = new Thermometer_Deel4(104);
    ...
    {
    	Assertions.assertThrows(IllegalArgumentException.class , () -> {new Thermometer_Deel4(13);});
    }
	
	@Test
	public void converteerNaarCelcius_50F_geeft10C() {
		t = new Thermometer_Deel4(50);
